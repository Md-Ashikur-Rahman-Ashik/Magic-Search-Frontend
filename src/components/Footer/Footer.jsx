...
const Footer = () => {
  return (
    <footer className="bg-[#0D0D0D] mt-10">
      <div className="container p-6 mx-auto text-center md:text-left">
          ...
          <div className="w-full lg:w-1/2">
            <div className="px-6">
              ...
              <div className="flex mt-6 justify-center lg:justify-normal">
                <Link
                  href="#"
                  className="mx-2 text-white transition-colors duration-300 dark:text-white hover:text-white dark:hover:text-white"
                  aria-label="Reddit"
                >
                  <svg
        ...
        <hr className="h-px my-6 bg-green-50 border-none dark:bg-gray-700" />

        <div>
          <p className="text-center text-white">
            © Magic Search 2024 - All rights reserved
          </p>
        </div>
      </div>
    </footer>
